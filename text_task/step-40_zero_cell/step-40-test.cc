...
namespace Step40
{
  ...
  {    
    ...
    DataOutBase::DataOutFilter data_filter(
      DataOutBase::DataOutFilterFlags(false, true));
    data_out.write_filtered_data(data_filter);
    data_out.write_hdf5_parallel(data_filter, "solution.h5", mpi_communicator);
    std::vector<XDMFEntry> xdmf_entries;
    xdmf_entries.push_back(
      data_out.create_xdmf_entry(data_filter, "solution.h5", 0, mpi_communicator));

    data_out.write_xdmf_file(xdmf_entries, "solution.xdmf", mpi_communicator);
    ...
    //cat_file("solution.xdmf");
    //std::ifstream f("solution.h5");
