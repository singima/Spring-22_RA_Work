...
namespace Step40
{
  ...
  void LaplaceProblem<dim>::output_results(const unsigned int cycle) const
  {
    ...
    // THIS IS WHERE I EDIT SHIT
    // start time of function call
    auto start = high_resolution_clock::now();

    //
    // I think this is the function that we care about and need to record the time
    // We will compare time with ways to write the data.
    ...
    cout << "Time taken by the write_vtu_with_pvtu_record() function: "
