...
Meshsize = .25;// Change this for the meshsize of the lines
...
// Top left Curve
Point(20) = {-.5 * C, .5 * L - B - R, 0, Meshsize}; 
Point(21) = {-.5 * C,         .5 * A, 0, Meshsize}; 
Ellipse(17) = {12, 21, 20, 8};

// Top right curve
Point(22) = {.5 * C, .5 * L - B - R, 0, Meshsize};  
Point(23) = {.5 * C,         .5 * A, 0, Meshsize};
Ellipse(18) = {15, 23, 22, 9};

// Bottom left curve
Point(24) = {-.5 * C, -.5 * L + B + R, 0, Meshsize}; 
Point(25) = {-.5 * C,         -.5 * A, 0, Meshsize}; 
Ellipse(19) = {16, 25, 24, 10};

// Bottom right curve
Point(26) = {.5 * C, -.5 * L + B + R, 0, Meshsize}; 
Point(27) = {.5 * C,         -.5 * A, 0, Meshsize};
